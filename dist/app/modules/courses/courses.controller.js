...
const createCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield courses_service_1.courseServices.createCourseIntoDB(req.body);
...
const getAllCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { result, meta } = yield courses_service_1.courseServices.getAllCourseFromDB(req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const getSingleCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield courses_service_1.courseServices.getSingleCourseFromDB(courseId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const updateCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { courseId } = req.params;
    const result = yield courses_service_1.courseServices.updateCourseIntoDB(courseId, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const deleteCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { courseId } = req.params;
    const result = yield courses_service_1.courseServices.deleteCourseIntoDB(courseId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const getCourseReview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { courseId } = req.params;
    const result = yield courses_service_1.courseServices.getCourseReviewFromDB(courseId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
